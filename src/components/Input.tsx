...
const Input = () => {
  ...
  return (
    <div className={cls.inputGroup}>
      <div className={cls.inputLeftElement}>
      ...
      <input type="text" placeholder="Search" className={cls.input} value={value} onChange={e => setValue(e.target.value)} />
      <div className={cls.inputRightElement}>
        {value ? (
          <button className={cls.buttonX} aria-label='Reset search' onClick={() => setValue('')}>
